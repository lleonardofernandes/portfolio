...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function calcularAnos(dataInicial) {
        ...
        let anos = hoje.getFullYear() - dtInicio.getFullYear();
        const mes = hoje.getMonth() - dtInicio.getMonth();
        const dia = hoje.getDate() - dtInicio.getDate();
    ...
    const dataNascimento = '1990-04-21';
    const dataExperiencia = '2018-01-01';

    document.getElementById('idade').textContent = calcularAnos(dataNascimento);
    document.getElementById('experiencia').textContent = calcularAnos(dataExperiencia);
    document.getElementById('experiencia2').textContent = calcularAnos(dataExperiencia);
